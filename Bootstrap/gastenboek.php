...
<html lang="en">
    ...
    <body>
        ...
        <form role="form">
                    ...
                    <div class="form-group">
                    <textarea class="form-control" type="textarea" id="message" placeholder="Vul hier je bericht in" maxlength="140" rows="7"></textarea>				
                    </div>
					<div class="form-group">
	...
	<a href="berichten.html"><?php echo $lang['bekijkberichten'] ?></a>
                        </p>
                    </div>
