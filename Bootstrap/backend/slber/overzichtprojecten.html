        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h1 class="page-header">Projecten leerlingen</h1>
                </div>
            </div></div>  
                                ...
                                <ul class="treeview">
                                    <li><a href="#">Klas</a>
                                        <ul>
                                            <li><a href="#">INF1I</a>
                                                <ul>
                                                    <li><a href="projecten.html">Dennis Kramer</a></li>
                                                    <li><a href="projecten.html">Chiel Timmermans</a></li>
                                                    <li><a href="projecten.html">Tom Verra</a></li>
                                                    <li><a href="projecten.html">Siem Schippers</a></li>
                                                    <li><a href="projecten.html">Tom Verra</a></li>
                                                    <li><a href="projecten.html">Randy Rijkshoorn</a></li>
                                                    <li><a href="projecten.html">Jefrey Meijer</a></li>
                                                    <li><a href="projecten.html">Fekke Fekkes</a></li>
