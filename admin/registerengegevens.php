...
//     password encrypt using SHA256();
    ...
    if (!$error) {
        ...
        $query3 = "INSERT INTO portfoliotext VALUES ('$stnummer', 'Voer text in', 'Voer text in','Voer text in','Voer text in', 'Voer hier text in', 'Voer text in', 'leeg_profielfoto.jpg')";
        ...
        <form action="registerengegevens.php" method="post" class="form-horizontal">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="studentnummer" class="form-control input-md" type="number" name="studentnummer" value="<?php echo $stnummer; ?>" required="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="Klas" placeholder="Class" value="<?php echo $klas; ?>" class="form-control input-md" required="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="voornaam" placeholder="Firstname"  value="<?php echo $fname; ?>" class="form-control input-md" required="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="achternaam" placeholder="Surname" value="<?php echo $lname; ?>" class="form-control input-md" required="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="number" name="telnummer" value="<?php echo $telnum; ?>" class="form-control input-md" required="">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="number" name="huisnummer" value="<?php echo $hnum; ?>" class="form-control input-md" required="">
